package com.example.doctorwang.forever2.modules.contact.activity;
...
import com.example.doctorwang.forever2.modules.contact.constant.UserConstant;
import com.example.doctorwang.forever2.modules.contact.helper.UserUpdateHelper;
import com.example.doctorwang.forever2.modules.model.FriendDataCache;
        ...
        RequestCallbackWrapper callback = new RequestCallbackWrapper() {
            ...
            public void onResult(int code, Object result, Throwable exception) {
                ...
                if (code == ResponseCode.RES_SUCCESS) {
                    ...
                    Toast.makeText(UserProfileEditItemActivity.this, R.string.user_info_update_failed
