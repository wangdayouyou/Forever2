package com.example.doctorwang.forever2.modules.login;
...
import com.example.doctorwang.forever2.modules.contact.ContactHttpClient;
import com.example.doctorwang.forever2.modules.main.MainActivity;
...
public class LoginActivity extends UI implements OnKeyListener {
    ...
    private void requestBasicPermission() {//请求基础权限
    ...
    private void register() {
        ...
        if (!NetworkUtil.isNetAvailable(LoginActivity.this)) {//网络问题
