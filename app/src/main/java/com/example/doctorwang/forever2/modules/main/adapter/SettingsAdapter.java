package com.example.doctorwang.forever2.modules.main.adapter;
...
public class SettingsAdapter extends BaseAdapter {
    ...
    private void updateHeadItem(ViewHolder viewHolder) {
        ...
        viewHolder.headTitleView.setText( NimUserInfoCache.getInstance().getUserName( DemoCache.getAccount()));
