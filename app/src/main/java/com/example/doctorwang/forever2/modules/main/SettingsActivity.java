...
import com.example.doctorwang.forever2.modules.avchat.activity.AVChatSettingsActivity;
import com.example.doctorwang.forever2.modules.contact.activity.UserProfileSettingActivity;
import com.example.doctorwang.forever2.modules.main.adapter.SettingsAdapter;
import com.example.doctorwang.forever2.modules.main.model.SettingTemplate;
import com.example.doctorwang.forever2.modules.main.model.SettingType;
...
import static com.netease.nim.uikit.impl.preference.UserPreferences.setEarPhoneModeEnable;
...
//                UserPreferences.getNotificationFoldedToggle()));
        ...
        items.add(new SettingTemplate(TAG_SPEAKER, getString(R.string.msg_speaker), SettingType.TYPE_TOGGLE,
                com.netease.nim.uikit.impl.preference.UserPreferences.isEarPhoneModeEnable()));
    ...
    public void onSwitchChange(SettingTemplate item, boolean checkState) {
        switch (item.getId()) {
            case TAG_NOTICE:
                ...
                break;
            case TAG_SPEAKER:
                com.netease.nim.uikit.impl.preference.UserPreferences.setEarPhoneModeEnable(checkState);
