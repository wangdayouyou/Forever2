...
import com.example.doctorwang.forever2.modules.avchat.constant.CallStateEnum;
import com.example.doctorwang.forever2.modules.avchat.widgets.ToggleListener;
import com.example.doctorwang.forever2.modules.avchat.widgets.ToggleState;
import com.example.doctorwang.forever2.modules.avchat.widgets.ToggleView;
...
public class AVChatVideo implements View.OnClickListener, ToggleListener {
    ...
    private void showProfile(){
        ...
        nickNameTV.setText( NimUserInfoCache.getInstance().getUserName(account));
    }
